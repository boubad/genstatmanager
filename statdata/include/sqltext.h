...
const char *StatDataManager<TSTRING>::SQL_COMMIT_TRANSACTION =
		"COMMIT TRANSACTION";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_BEGIN_TRANSACTION =
		"BEGIN TRANSACTION";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_ROLLBACK_TRANSACTION =
		"ROLLBACK TRANSACTION";
////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_CREATE_DATASET =
...
//////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_ALL_DATASETS =
		"SELECT datasetid,optlock,sigle,nom,description"
				" FROM dbdataset ORDER BY sigle";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_BY_ID =
		"SELECT datasetid,optlock,sigle,nom,description"
				" FROM dbdataset WHERE datasetid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_BY_SIGLE =
		"SELECT datasetid,optlock,sigle,nom,description"
				" FROM dbdataset WHERE UPPER(LTRIM(RTRIM(sigle))) = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INSERT_DATASET =
		"INSERT INTO dbdataset (sigle,nom,description)"
				" VALUES (?1,?2,?3)";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_UPDATE_DATASET =
		"UPDATE dbdataset SET optlock = optlock + 1,"
				" sigle = ?1, nom = ?2, description = ?3 WHERE datasetid = ?4";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_REMOVE_DATASET =
		"DELETE FROM dbdataset WHERE datasetid = ?1";
///////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_CREATE_VARIABLE =
...
/////////////////////////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_VARIABLES =
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_VARIABLES_IDS =
		"SELECT variableid FROM dbvariable WHERE datasetid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_VARIABLE_BY_DATASET_AND_SIGLE =
		"SELECT variableid,optlock,datasetid,sigle,vartype,categvar,nom,description, genre"
				" FROM dbvariable WHERE datasetid = ?1 AND UPPER(LTRIM(RTRIM(sigle))) = ?2";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_VARIABLE_BY_ID =
		"SELECT variableid,optlock,datasetid,sigle,vartype,categvar,nom,description, genre"
				" FROM dbvariable WHERE variableid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INSERT_VARIABLE =
		"INSERT INTO dbvariable (datasetid,sigle,vartype,categvar,nom,description,genre)"
				" VALUES (?1, ?2,?3,?4,?5,?6,?7)";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_UPDATE_VARIABLE =
...
////////////////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_INDIVS_COUNT =
		"SELECT COUNT(*) FROM dbindiv"
				" WHERE datasetid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_INDIVS =
		"SELECT individ,optlock,datasetid,sigle,nom,description,status"
				" FROM dbindiv WHERE datasetid = ?1 ORDER BY sigle";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_INDIVS_PAGED =
		"SELECT individ,optlock,datasetid,sigle,nom,description,status"
				" FROM dbindiv WHERE datasetid = ?1 ORDER BY sigle"
				" LIMIT ?2 OFFSET ?3"; 
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INDIV_BY_DATASET_AND_SIGLE =
		"SELECT individ,optlock,datasetid,sigle,nom,description,status"
				" FROM dbindiv WHERE datasetid = ?1 AND UPPER(LTRIM(RTRIM(sigle))) = ?2";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_INDIV_BY_ID =
		"SELECT individ,optlock,datasetid,sigle,nom,description,status"
				" FROM dbindiv WHERE individ = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INSERT_INDIV =
		"INSERT INTO dbindiv (datasetid,sigle,nom,description,status)"
				" VALUES(?1,?2,?3,?4, ?5)";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_UPDATE_INDIV =
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_INDIVS_BY_DATASET_AND_STATUS =
		"SELECT individ,optlock,datasetid,sigle,nom,description,status"
...
////////////////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_CREATE_VALUE =
...
/////////////////////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_VARIABLE_TYPE =
		"SELECT vartype FROM dbvariable WHERE variableid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_VALUES_COUNT =
		"SELECT COUNT(*)"
				" FROM dbvalue a, dbvariable b"
				" WHERE a.variableid = b.variableid AND b.datasetid = ?1";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_BY_STATUS_VALUES_COUNT =
		"SELECT COUNT(*)"
				" FROM dbvalue a, dbindiv b"
				" WHERE a.individ = b.individ AND b.datasetid = ?1 AND UPPER(LTRIM(RTRIM(b.status))) = ?2";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_VALUES =
		"SELECT a.valueid,a.optlock,a.variableid,a.individ,a.stringval"
				...
				" LIMIT ?2 OFFSET ?3";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_FIND_DATASET_BY_STATUS_VALUES =
		"SELECT a.valueid,a.optlock,a.variableid,a.individ,a.stringval"
				" FROM dbvalue a, dbindiv b"
				" WHERE a.individ = b.individ AND b.datasetid = ?1 AND UPPER(LTRIM(RTRIM(b.status))) = ?2"
				" ORDER BY a.variableid ASC, a.individ ASC"
				" LIMIT ?3 OFFSET ?4";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_VALUES_BY_VARIABLE_INDIV =
		"SELECT valueid,optlock,variableid,individ,stringval"
				" FROM dbvalue WHERE variableid = ?1 AND individ = ?2";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_VALUES_BY_VARIABLE_NOT_NULL =
		"SELECT valueid,optlock,variableid,individ,stringval"
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INSERT_VALUE =
		"INSERT INTO dbvalue (variableid,individ,stringval)"
				" VALUES(?1,?2,?3)";
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_UPDATE_VALUE =
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_INDIVS_VIEW =
		"CREATE VIEW IF NOT EXISTS"
				" indview AS"
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_VARS_VIEW =
		"CREATE VIEW IF NOT EXISTS"
				" varview AS"
...
template<class TSTRING>
const char *StatDataManager<TSTRING>::SQL_DATASETS_VIEW =
		"CREATE VIEW IF NOT EXISTS"
				" datasetview AS"
...
//////////////////////////////////////////////////////
template<class TSTRING>
const char *StatDataManager<TSTRING>::CREATE_SQL[] = {
		StatDataManager<TSTRING>::SQL_CREATE_DATASET,
		StatDataManager<TSTRING>::SQL_CREATE_VARIABLE,
		StatDataManager<TSTRING>::SQL_CREATE_INDIV,
		StatDataManager<TSTRING>::SQL_CREATE_VALUE,
		StatDataManager<TSTRING>::SQL_CREATE_VIEW_VALUES, StatDataManager<
				TSTRING>::SQL_INDIVS_VIEW,
		StatDataManager<TSTRING>::SQL_VARS_VIEW,
		StatDataManager<TSTRING>::SQL_DATASETS_VIEW, nullptr };
//////////////////////////////////////////////////
